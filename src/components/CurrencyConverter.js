...
import {Paper, TextField, MenuItem, makeStyles, FormControl } from "@material-ui/core";
...
heading:{
 ...
 return(
    ...
    <h1 className={classes.heading}>Currency Converter</h1>
              <p className={classes.para}>Use this instant currency converter for all major
                currencies, with exchange rates that are updated several times a day.</p>
            </div>
    ...
    <TextField type="number" value={inputAmount}  onChange={handleInputAmountChange}  variant='outlined' 
      helperText="Enter amount" margin='normal'
    /> 
    ...
    <MenuItem key={currencyCode} value={currencyCode}>
      ...
      <TextField value={convertedAmount} 
      variant='outlined' helperText="Result" margin='normal' /> 
      </FormControl>
      </Paper>
  // </div>
);
